         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
             ...
             <tr>
                ...
                <td><IMG SRC="<%= u.getImage()%>"  WIDTH="50" HEIGHT="50" /></td>
                <td><%= u.getNom()%></td>
                <td><%= u.getDescription()%></td>
                <td><%= u.getPrix()%></td>
                
                <td> <a href="Produit?id=<%= u.getId()%>&action=delete"> <input class="btn btn-danger" type="button" value="Delete"> </a> <a href="Produit?id=<%= u.getId()%>&action=edit"> <input class="btn btn-success" type="button" value="Edit"> </a></td>
            ...
            <%} %>
                        ...
                        <br>
      <a href="addproduit.jsp"> <input class="btn btn-warning" type="button" value="Add"> </a>
                        </div>
                    </div>
