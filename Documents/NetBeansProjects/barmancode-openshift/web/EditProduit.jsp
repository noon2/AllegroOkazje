...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   %>
    <%
        Produit u = (Produit) request.getAttribute("produit");
        %>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                          ...
                          <form action="ConfirmEditProduit" method="post">
      <table>
           ...
           <tr>
            ...
            <tr>
                <td>Prix:</td>
                <td><input type="text" name="prix" value="<%= u.getPrix()%>" /></td>
           </tr>
           
             <tr>
                <td>Image:</td>
                <td><input type="text" name="image" value="<%= u.getImage()%>" /></td>
           </tr>
           
           
           <tr>
                <td></td>
                <td><input class="btn btn-warning" type="submit" value="Edit"> <a href="listProduit.jsp"> <input class="btn btn-inverse"  type="button" value="Cancel"> </a></td>
           </tr>
