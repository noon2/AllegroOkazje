...
public final class Client {
	public static final String tag = "allegro";
	public static final String API_NAMESPACE = "https://webapi.allegro.pl/uploader.php";
	public static final String API_KEY = "ed02cd1d";
	...
	public Object sendRequest(final SoapObject rpc) {
